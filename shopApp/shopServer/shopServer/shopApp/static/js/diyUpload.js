...
(function( $ ) {
    ...
    $.fn.extend({
        ...
        diyUpload:function( opt, serverCallBack ) {
            ...
            window.webUploader = getUploader( opt );
            console.log("实例化好了 uploader...")
